...
- **Hugo extended 0.162–0.165** (el rango que soporta Blowfish v3.6; la CI usa 0.165.0). En macOS: `brew install hugo`. Para otros sistemas, consulta la [guía de instalación](https://gohugo.io/installation/).
